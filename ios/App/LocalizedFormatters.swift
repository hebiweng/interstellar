...
enum LocalizedFormatters {
    ...
    static func remainingDays(_ count: Int, language: AppLanguage) -> String {
        localizedCountTemplate("format.remaining-days.one", "format.remaining-days.other", count: count, language: language)
    }

    static func remainingHours(_ count: Int, language: AppLanguage) -> String {
        localizedCountTemplate("format.remaining-hours.one", "format.remaining-hours.other", count: count, language: language)
    }
