...
enum InsightFactory {
    static func make(
        ...
        if usesModernTransitPlan {
            ...
            cards = transitCards(
                plan: plan,
                language: language,
                initialRangeDays: transitRangeDays
            )
        } else {
            transitPlan = nil
            cards = switch chart {
        ...
        return [
            ...
            card( id: "current-cycles",
                ...
                icon: "◔", visual: .cycleTabs(
                    long: TransitCyclePresentation(
                        roleID: TransitEvidenceRole.longCycle.rawValue,
                        fallbackTitle: cycleLong.title,
                        tags: cycleLong.meta.isEmpty ? [] : [cycleLong.meta],
                        sourceFactIDs: []
                    ),
                    current: TransitCyclePresentation(
                        roleID: TransitEvidenceRole.currentCycle.rawValue,
                        fallbackTitle: cycleCurrent.title,
                        tags: cycleCurrent.meta.isEmpty ? [] : [cycleCurrent.meta],
                        sourceFactIDs: []
                    ),
                    daily: TransitCyclePresentation(
                        roleID: TransitEvidenceRole.dailyCycle.rawValue,
                        fallbackTitle: cycleDaily.title,
                        tags: cycleDaily.meta.isEmpty ? [] : [cycleDaily.meta],
                        sourceFactIDs: []
                    )
                ),
                facts: top.prefix(3).map {
            ...
            card( id: "transit-timeline",
                ...
                visual: .transitTimeline(
                    ...
                    initialRangeDays: TransitTimelineContract.defaultRangeDays,
    ...
    private static func transitPlanetPathRows(
        _ plan: CardEvidencePlan,
        anchorDate: Date,
        language: AppLanguage,
        timeZone: TimeZone
    ...
    private static func transitLifeAreaRows(
        _ plan: CardEvidencePlan,
        language: AppLanguage
    ) -> [TransitLifeAreaRow] {
    ...
    private static func transitActiveRows(
        _ plan: CardEvidencePlan,
        anchorDate: Date,
        language: AppLanguage,
        timeZone: TimeZone
    ...
    private static func transitInHouseTitle(_ body: CelestialBody, house: Int, language: AppLanguage) -> String {
        localized(
    ...
    private static func transitEnteringHouseTitle(_ body: CelestialBody, house: Int, language: AppLanguage) -> String {
        localized(
    ...
    private static func transitActiveAspectTitle(_ aspect: TransitAspectFact, language: AppLanguage) -> String {
    ...
    private static func transitActiveEventTitle(_ event: TransitPlanetEventFact, language: AppLanguage) -> String {
    ...
    private static func activeAspectTiming(
    ...
    private static func activeStatusLabel(_ status: TransitActiveStatus, language: AppLanguage) -> String {
        switch status {
    ...
    private static func transitHouseLabel(_ house: Int, language: AppLanguage) -> String {
    ...
    private static func transitTimestamp(_ date: Date, language: AppLanguage, timeZone: TimeZone) -> String {
    ...
    private static func transitUntilMonth(_ date: Date, language: AppLanguage, timeZone: TimeZone) -> String {
        let formatter = DateFormatter()
        formatter.locale = Locale(identifier: language.rawValue)
        formatter.timeZone = timeZone
    ...
    private static func relativeTransitTime(
        from start: Date,
        to end: Date,
        language: AppLanguage,
        includesPrefix: Bool
    ...
    private static func cycleWindowTags(
        _ window: TransitWindowFact,
    ...
    private static func cyclePhase(_ window: TransitWindowFact, anchorDate: Date) -> AspectPhase {
    ...
    private static func cycleDuration(_ start: Date, _ end: Date, language: AppLanguage) -> String {
    ...
    private static func cycleDateRange(
        _ start: Date,
        _ end: Date,
        anchorDate: Date,
        language: AppLanguage,
