...
export const chartTechniques: Array<{ id: TechniqueId; label: string; status: "active" | "planned"; stage: string; inputs: string; outputs: string }> = [
  ...
  { id: "tertiary_progressions", label: "三限盘", status: "active", stage: "可用", inputs: "人物＋目标日期", outputs: "本命＋三限双轮、时间线" },
  { id: "solar_return", label: "日返盘", status: "active", stage: "可用", inputs: "人物＋目标年份与地点", outputs: "太阳返照盘与年度主题" },
  { id: "lunar_return", label: "月返盘", status: "active", stage: "可用", inputs: "人物＋目标月份与地点", outputs: "月亮返照盘与月度主题" },
  { id: "solar_arc", label: "日弧盘", status: "active", stage: "可用", inputs: "人物＋目标日期", outputs: "太阳弧双轮、弧向命中" },
  { id: "firdaria", label: "法达", status: "active", stage: "可用", inputs: "人物＋目标日期", outputs: "主限、次限与起始日期" },
  { id: "annual_profections", label: "小限", status: "active", stage: "可用", inputs: "人物＋目标年份", outputs: "年小限宫位、主星与时间线" },
  { id: "relocation", label: "重置盘", status: "active", stage: "可用", inputs: "人物＋目标地点", outputs: "重置地点后的四轴、宫位与轮盘" },
  { id: "dodecatemoria", label: "12分盘", status: "active", stage: "可用", inputs: "人物＋十二分规则", outputs: "Dodecatemoria 十二分位置与轮盘" },
  { id: "tridecatemoria", label: "13分盘", status: "active", stage: "可用", inputs: "人物＋十三分规则", outputs: "十三分位置与轮盘" },
